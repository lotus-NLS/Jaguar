...
#
#     def open(self, url: str):
#         """Opens the specified scrape. Use url=search://{search_term} to perform a google search insted"""
...
#             self.search_context += f'({index}): {scrape}\n'
#
#     def visit_site(self, url : str):
#         """Visits the selected scrape in the browser"""
...
#         info_text = f'---> Currently visiting scrape: {self.currrent_url}\n'
...
#
#     def get_desc(self) -> str:
#         return f"A browser allowing you to perform a google search and scrape sites"
