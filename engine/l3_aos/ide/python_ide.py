...
from engine.l3_aos.ide.node import SourceNode
...
class PythonIDE(Workspace):
    ...
    def __init__(self):
        ...
        self.root_node : Optional[SourceNode] = None
    ...
    def open(self, project_dirpath : str):
        ...
        self.root_node = SourceNode.create_tree(source_path=project_dirpath)
    ...
    def open_file(self, projectFileNo : int):
        ...
        idx_to_node = self.root_node.get_idx_to_node()
        fpath = idx_to_node[idx].source_path
