...
- Guarantee in every `__init__`: Every class attribute fulfills its type hint at any point after `__init__`.
- Assume in every class instance scope: Every attribute fulfills its type hint at any point after `__init__`.
