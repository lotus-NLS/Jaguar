...
- Commit messages header: Introduced : New module, Extended : Appended new code to existing module, Rewrote : Changing existing code, Refactored : Only changed naming
